...
echo "[Entrypoint] Dropping privileges and starting Application..."
# Pass the XDG runtime explicitly to the final process
exec su retro -c "export XDG_RUNTIME_DIR=$XDG_RUNTIME_DIR; $*"
